...
<li>
	预备工作:
	请事先修改好config.php的内容;<br>
	请保证oauth_config.php 可写;<br>
<a href="oauth-php/library/store/mysql/install.php" target="_blank"> .安装数据库: </a> <br>
</li>
<ol>

<li>
<a href="register.php" target="_blank">.注册应用[服务器端]</a><br><br>
注册应用其实就是其他开放平台做的申请应用这一步;<br><br>
</li>
<li>
<a href="save_server.php" target="_blank">.保存应用信息和服务器信息[应用端]</a><br><br>
好了，在开放平台申请到了应用,现在把key和回调地址这些信息都保存起来;<br>
<br>
</li>
<li>
<a href="logout.php" target="_blank">.为了调试方便,服务端先退出[服务端]</a><br><br>
<br>
</li>
<li>
<a href="client_index.php" target="_blank">.应用端引导用户前往授权[应用端]</a><br><br>
模拟了大家用新浪微博,腾讯微博,淘宝开放平台常见的给应用授权这一步;<br>
授权完成之后，服务器端又引导用户浏览器回到了cb.php，同时传了一个token过去;在cb.php里就用这个token取到了access token;<br><br>
</li>
<li>
<a href="call.php" target="_blank">执行调用[应用端]</a><br><br>
